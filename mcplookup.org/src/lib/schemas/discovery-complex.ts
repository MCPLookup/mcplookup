 ...
 * Distinguishes between GitHub-based servers and official domain-registered servers
 */
...
// ============================================================================
// MAIN SERVER RECORD TYPE - NOW FROM SDK
// ============================================================================

// MCPServerRecord is now imported from @mcplookup-org/mcp-sdk
// This eliminates type duplication and ensures consistency across all components
// The SDK type includes all fields that were previously defined here

// For Zod validation in API routes, we can create a schema from the TypeScript type
// when needed using zod's z.custom() or by creating minimal validation schemas
...
// MCPServerRecord is now imported from SDK above
export type DiscoveryRequest = z.infer<typeof DiscoveryRequestSchema>;
export type DiscoveryResponse = z.infer<typeof DiscoveryResponseSchema>;
export type RegistrationRequest = z.infer<typeof RegistrationRequestSchema>;
